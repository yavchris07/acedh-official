...
const CreateResource = ({ onClose, onRefresh, open }: createResourceProps) => {
  ...
  const { createResource, pending, fail } = useCreateResource();
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await onRefresh();
      showToast("Ressource créé avec succès", "success");
      onClose();
    } catch (err) {
      console.error(err);
